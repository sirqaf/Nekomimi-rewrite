...
if (member){
  message.channel.send(`${message.member.user.username} is cuddling with ${member.username}`, {
    files: [image],
  });
} else {
      message.channel.send(`${message.member.user.username} is cuddling with someone`, {
        files: [image],
      });
    }
      console.log(data);
