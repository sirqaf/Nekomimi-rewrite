...
if (member){
  message.channel.send(`${message.member.user.username} is biting ${member.username}, ouchh`, {
    files: [image],
  });
} else {
      message.channel.send(`${message.member.user.username} is biting someone, ouchh`, {
        files: [image],
      });
    }
      console.log(data);
